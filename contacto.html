...
<body>
    ...
    <main>
        ...
        <div class="seccion">
            <div class="card2">
                <div class="img">
                    <img src="https://www.echelonseniorliving.com/wp-content/uploads/2021/11/contactus.jpg"img-cover" alt="card1">
                </div>
                <div class="contenido">
                    <div class="title">
                        <h2>Contactanos</h2>
    ...
    <footer>
        ...
        <div class="copy-right">
            <p>Gad la Victoria ® 2023 Todos los derechos reservados | Developed by Cintia Ganchala</p>
        </div>
    </footer>
</body>
</html>
